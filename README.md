...
Built on [claude-usage-widget](https://github.com/bozdemir/claude-usage-widget) by Burak Özdemir, MIT. This fork is MIT as well — see [LICENSE](LICENSE). Not affiliated with Anthropic.
